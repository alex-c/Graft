...
namespace Graft.Default
{
    public class Graph<TV, TW> : IGraph<TV>
    {
        ...
        {
            Verteces = new List<Vertex<TV>>();
            Adjacency = new Dictionary<TV, List<Edge<TV, TW>>>();
            IsDirected = isDirected;
        }

        public Graph(List <Vertex<TV>> verteces, Dictionary<TV, List<Edge<TV, TW>>> adjacency, bool isDirected = false) : this(isDirected)
        {
            Verteces = verteces;
            Adjacency = adjacency;
        }
